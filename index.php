...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" typle="text/css" href="resources/css/style.css">
        <link rel="stylesheet" typle="text/css" href="resources/css/queries.css">
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                ...
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-feature">
                        <i class="ion-ios-star icon-small icon-small"></i>
                        160+ top chefs
                    </div>
                    <div class="city-feature">
                        <i class="ion-social-twitter icon-small"></i>
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal every 10 days/month</li>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 24/7</li>
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            if($_GET['success'] == -1) {
                                echo "div class=\"form-essages error\">Oops! Something went wrong. Please try again!</div>";
                            }
                            ?>
                        </div>    
                            <div class="row">
    ...
    <script scr="https://cdn.jsdelivr.net/g/respond@1.4.2,html5shiv@3.7.3,selectivizr@1.0.3b"></script>
    <script src="vendors/js/jquery.waypoints.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZw8Uff1lut6vh2VUUy4J8PkBt_qPex0"></script>
